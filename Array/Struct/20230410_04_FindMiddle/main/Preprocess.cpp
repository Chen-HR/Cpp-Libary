...
int main()
  {
    ...
    size_t length; std::cout<<"data length: "; length=6;
    std::cout<<std::endl;
    struct Array<size_t, size_t> Data(length);
    setRandomElement_Array(Data);
    std::cout<<Data<<std::endl;
    std::cout<<"middle element: "<<findMiddle_Array(Data)<<std::endl;
    std::cout<<"middle element: "<<findOrder_Array(Data, Data.length>>1)<<std::endl;
    std::cout<<Data<<std::endl;
  }
