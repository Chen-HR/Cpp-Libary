   ...
   */
  template <typename Type, typename Size> class Array
    {
      private:
      protected:
      ...
      public:
         ...
         */
        inline Array<Type, Size>& set_Array(Type* _start, Size length);
        /**
         * @brief Reconfigure a group of spaces, initialized as an array
         * @param other referenced object
         * @return Array<Type, Size>& *this
        ...
        Array<Type, Size> subArray(Size index, Size length);
