...
#include "Log.hpp"
  ...
  Stream::StreamTool::StreamTool(char* Indentation_, bool nameEnable_, bool stdoutEnable_, bool stdlogEnable_, bool stderrEnable_)
    ...
    {}
  Stream::StreamTool::StreamTool(char* Indentation_, short booleanList)
    ...
    {}
  Stream::StreamTool Stream::StreamTool::setStreamTool(char* Indentation_, bool nameEnable_, bool stdoutEnable_, bool stdlogEnable_, bool stderrEnable_)
    {
  ...
  Stream::StreamTool Stream::StreamTool::setStreamTool(char* Indentation_, short booleanList)
    {
      this->Indentation  = Indentation_ ;
  ...
  template <class Type> inline Type Stream::StreamTool::stdinReader()
    {
      Type buffer;
      std::cin>>buffer;
      return buffer;
  ...
  template <class DescriptionType, class IndentationType, class IndentationLevelType> 
    void Stream::StreamTool::putDescription(DescriptionType Description, IndentationType Indentation, IndentationLevelType IndentationLevel, bool endLine)
      {
  ...
  template <class ValueType, class DescriptionType, class IndentationType, class IndentationLevelType>
    void Stream::StreamTool::getValueWithDescription(ValueType& Value, DescriptionType Description, IndentationType Indentation, IndentationLevelType IndentationLevel)
      {
        if (this->nameEnable) std::cout<<"stdout: ";
        for (IndentationLevelType index=0; index<IndentationLevel; index++) std::cout<<this->Indentation;
